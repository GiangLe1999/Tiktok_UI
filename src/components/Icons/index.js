export const EllipsisIcon = ({ className, width = '2rem', height = '2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ClearIcon = ({ className, width = '2rem', height = '2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LoadingIcon = ({ className, width = '2rem', height = '2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ShortcutIcon = ({ className, width = '2rem', height = '2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
